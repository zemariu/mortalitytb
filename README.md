...
The study aimed to characterise the temporal and spatial distribution of tuberculosis mortality across Brazilian municipalities between 2010 and 2024, examine contextual factors associated with mortality, and develop a Bayesian municipal prioritisation framework.
...
- hotspot persistence and newly identified;
...
- evaluating hotspot newly identified and attenuated;
...
- assigning component scores for spatial classification, hotspot persistence or newly identified, relative risk, exceedance probability, temporal trend, temporal evidence, regime stability, and state context;
...
| `hotspot_status` | Persistence, newly identified, attenuated, or absence of hotspot status. |
...
2.  hotspot persistence or newly identified;
